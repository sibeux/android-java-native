...
public class HacktivSesi6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (namaLengkap.getText().toString().length()==0){
                ...
                }else if (universitas.getText().toString().length()==0){
                    ...
                    Intent intent = new Intent(String.valueOf(HacktivSesi6_view.class));
